        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-3" data-cursor="-opaque">Ajman</h1>
                    <nav class="wow fadeInUp">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('/home') }}">home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Ajman</li>
                        </ol>
                    </nav>
                </div>
                <!-- Page Header Box End -->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="vision-image">
                                <figure class="image-anime reveal">
                                    <img src="{{asset('assets/images/destination/50.jpg')}}" alt="Ajman City">
                                </figure>
                            </div>
                            <!-- Vision Image End -->
                        </div>
...
<div class="container">
    <div class="row section-row">
        <div class="col-lg-12">
            ...
            <div class="section-title">
                <h3 class="wow fadeInUp">Ajman</h3>
                <h2 class="text-anime-style-3">Top Attractions of Ajman</h2>
            </div>
            <!-- Section Title End -->
        </div>
    </div>
                ...
                <div class="swiper-wrapper" data-cursor-text="Drag">
                    ...
                    <div class="swiper-slide">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <img src="{{asset('assets/images/destination/51.jpg')}}" alt="Ajman Corniche">
                        </div>  
                        <center><h5>Ajman Corniche</h5></center>                          
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <img src="{{asset('assets/images/destination/52.jpg')}}" alt="Ajman Museum">
                        </div>  
                        <center><h5>Ajman Museum</h5></center>                            
                    </div>
                    <!-- Attraction Slide End -->
                    ...
                    <div class="swiper-slide">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <img src="{{asset('assets/images/destination/53.jpg')}}" alt="Al Zorah Nature Reserve">
                        </div>  
                        <center><h5>Al Zorah Nature Reserve</h5></center>                          
                    </div>
                    <!-- Attraction Slide End -->
                    ...
                    <div class="swiper-slide">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <img src="{{asset('assets/images/destination/54.jpg')}}" alt="Etisalat Tower">
                        </div>  
                        <center><h5>Etisalat Tower</h5></center>                          
                    </div>
                    <!-- Attraction Slide End -->
                    ...
                    <div class="swiper-slide">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <img src="{{asset('assets/images/destination/55.jpg')}}" alt="Al Murabaa Watchtower">
                        </div>  
                        <center><h5>Al Murabaa Watchtower</h5></center>                          
                    </div>
                    <!-- Attraction Slide End -->
                    ...
                    <div class="swiper-slide">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <img src="{{asset('assets/images/destination/56.jpg')}}" alt="Ajman Marina">
                        </div>  
                        <center><h5>Ajman Marina</h5></center>                          
                    </div>
                    <!-- Attraction Slide End -->
