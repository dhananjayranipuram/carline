...
<body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse main-menu">
                        <div class="nav-menu-wrapper">
                            <ul class="navbar-nav mr-auto" id="menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ url('/offers') }}">Special Offers</a>
                                </li>
                                ...
                                @if (session()->has('userdata') || session()->has('userId'))
                                    <li class="nav-item"><a href="{{ url('/my-account') }}" class="btn-default"
                                            style=" color: #ffffff; ">My Account</a></li>
                                @else
                                    <li class="nav-item"><a href="javascript:void(0);" class="btn-default register-user"
                                            style=" color: #ffffff; ">My Account</a></li>
                                @endif
                            </ul>
                        </div>
                    ...
                    @if (session()->has('userdata') || session()->has('userId'))
                        <div class="header-btn-mobile d-inline-flex">
                            <a href="{{ url('/my-account') }}" class="btn-mobile-account"><i
                                    class="fa fa-user"></i></a>
                        </div>
                    @else
                        <div class="header-btn-mobile d-inline-flex">
                            <a href="javascript:void(0);" class="btn-mobile-account register-user"><i
                                    class="fa fa-user"></i></a>
                        </div>
                    @endif
    ...
    <input type="hidden" id="userId"
        value="@if (session()->has('userId')) {{ Session::get('userId') }} @endif">
            ...
            <fieldset>
                <div class="row">
                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="text" id="firstName" class="booking-form-control" placeholder="First Name"
                            required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="text" id="lastName" class="booking-form-control" placeholder="Last Name"
                            required>
                        <div class="help-block with-errors"></div>
                    </div>

                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="email" id ="email" class="booking-form-control"
                            placeholder="Enter Your Email" required>
                        <div class="help-block with-errors"></div>
                    </div>

                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="text" id="phone" class="booking-form-control"
                            placeholder="Enter Your Mobile Number" required>
                        <div class="help-block with-errors"></div>
                    </div>

                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="password" id="password" class="booking-form-control" placeholder="Password"
                            required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="text" id="flat" class="booking-form-control"
                            placeholder="Flat/Villa number" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="text" id="building" class="booking-form-control"
                            placeholder="Building name" required>
                        <div class="help-block with-errors"></div>
                    </div>

                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="text" id="landmark" class="booking-form-control" placeholder="Landmark"
                            required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="booking-form-group col-md-6 mb-4">
                        <input type="text" id="city" class="booking-form-control"
                            placeholder="City/Emirates" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    ...
                    <div class="col-md-12 booking-form-group send-otp-button">
                        <label>Already registered? <a id="loginPopup" style="cursor:pointer; color:blue;">Login
                                here</a></label>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset>
                <div class="row">
                    <div class="booking-form-group col-md-12 mb-4">
                        <input class="booking-form-control" id="userName" type="text"
                            placeholder="Enter your email" autocomplete = "off" />
                        <div class="help-block with-errors"></div>
                    </div>

                    <div class="booking-form-group col-md-12 mb-4">
                        <input class="booking-form-control" id="userPassword" type="password"
                    ...
                    <div class="col-md-12 booking-form-group send-otp-button">
                        ...
                        <label>Not registered? <a id="registrationPopup" style="cursor:pointer; color:blue;">Register
                                here</a></label>
                    </div>
                </div>
            </fieldset>
    ...
    <div class="booking-form-box">
        ...
        <div id="forgotForm" class="white-popup-block mfp-hide booking-form">
            ...
            <fieldset>
                <div class="row">
                    <div class="booking-form-group col-md-12 mb-4">
                        <input class="booking-form-control" id="forgotEmailId" type="text"
                            placeholder="Enter your email" autocomplete = "off" />
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="row">
                    <div class="booking-form-group col-md-12 text-center">
                        <i class="fas fa-check-circle"
                            style="font-size: 100px; color: #006d09; margin-bottom: 20px;"></i>
                        ...
                        <div class="booking-form-group col-md-12 mb-4">
                            <div class="row">
                                <div class="booking-form-group col-md-6 mb-4">
                                    ...
                                    <input type="radio" class="form-check-input rider_type" name="rider_type"
                                        value="resident" checked> <label for="rider_type">Resident</label>
                                    &nbsp;<input type="radio" class="form-check-input rider_type" name="rider_type"
                                        value="tourist"> <label for="rider_type">Tourist</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="booking-form-group col-md-12 mb-4">
                            <div class="row" id="passport-section" style="display:none;">
                                ...
                                <div class="booking-form-group col-md-6 mb-4" id="passf" style="display:none;">
                                    ...
                                    <input type="file" name="pass_front" class="booking-form-control"
                                        placeholder="Front" accept="image/*" required>
                                ...
                                <div class="booking-form-group col-md-6 mb-4" id="passb" style="display:none;">
                                    ...
                                    <input type="file" name ="pass_back" class="booking-form-control"
                                        placeholder="Back" accept="image/*" required>
                        ...
                        <div class="booking-form-group col-md-12 mb-4" id="country-dl-section" style="display:none;">
                            <div class="row">
                                ...
                                <div class="booking-form-group col-md-6 mb-4" id="cdlf">
                                    <label>Front</label>
                                    <input type="file" name="cdl_front" class="booking-form-control"
                                        placeholder="Front" accept="image/*,application/pdf" required>
                                    <div class="help-block with-errors cdl_front"></div>
                                </div>
                                <div class="booking-form-group col-md-6 mb-4" id="cdlb">
                                    <label>Back</label>
                                    <input type="file" name="cdl_back" class="booking-form-control"
                                        placeholder="Back" accept="image/*,application/pdf" required>
    ...
    <div class="floating-chat-container">
        ...
        <div class="floating-chat-menu" id="chat-menu">
            ...
            <!-- WhatsApp Button -->
            <button class="chat-whatsapp-btn" type="button"
                onclick="window.open('https://wa.me/971581567345', '_blank')">
                <i class="fab fa-whatsapp"></i>
            </button>

            <!-- Email Button -->
            <button class="chat-email-btn" type="button"
                onclick="window.open('mailto:contact@growtharkmedia.com', '_blank')">
            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="about-footer">
                        ...
                        <div class="about-footer-content">
                            <p>We're fully flexible and client-focused, delivering cars when and where you need them.
                                Our goal is to provide a seamless rental experience tailored to your schedule. </p>
                        </div>
                    ...
                    <div class="footer-links footer-quick-links">
                        ...
                        <ul>
                            @foreach ($layoutCarTypes as $key => $value)
                                <li><a href="{{ url('/cars') }}" class="type-click"
                                        data-id="{{ $value->id }}">{{ $value->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <div class="footer-newsletter">
                        ...
                        <div class="about-footer">
                            <div class="about-footer-content">
                                <p><i class="fa fa-home"></i> Alliance Business Center<br>Dubai Silicon Oasis ,
                                    Dubai<br>United Arab Emirates</p>
                                ...
                                <p><i class="fa-brands fa-whatsapp"></i> <a
                                        href="https://api.whatsapp.com/send?phone=971581567345">+971 58 156 7345</a>
                                </p>
                                <p><i class="fa fa-envelope"></i> <a
                                        href="mailto:contact@growtharkmedia.com">contact@growtharkmedia.com</a></p>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-md-7">
                        ...
                        <div class="footer-copyright-text">
                            <p>© 2025 Carrental. All Rights Reserved. <br>Designed By <a href=""
                                    onclick="return false;" style="cursor: default;">GrowthArk Media</a></p>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-7">
                        ...
                        <div class="footer-copyright-text">
                            <center>
                                <p>Cards Accepted: </p><img src="{{ asset('assets/images/cards.png') }}"
                                    alt="">
                            </center>
                        </div>
                        <!-- Footer Copyright End -->
    ...
    $(document).ready(function() {
        $(".send-otp").click(function() {
            ...
            if (!validateForm(datas)) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status == 200) {
                            ...
                            $('.resend').html(
                                'Resend otp after <span class="countdown"></span>');
                            var timer2 = "00:30";
                            ...
                            $('#errorMessages').append(
                                '<br><span style="color:red;">OTP did not sent.</span>');
                            setTimeout(function() {
                                $('#errorMessages').html('');
                            }, 2500);
                        }
                ...
                $('#errorMessages').append(
                    '<br><span style="color:red;">Please fill valid data.</span>');
                setTimeout(function() {
                    $('#errorMessages').html('');
                }, 2500);
                $(".overlay").hide();
        ...
        function submit() {
            ...
            if (!validateForm(datas)) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        $('#errorMessages').append('<br><span style="color:green;">' + res.message +
                            '</span>');
                        setTimeout(function() {
                            $('#errorMessages').html('');
                        }, 2500);
            ...
            if (!validateForgotForm(datas)) {
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#resetErrors').html('<br><span style="color:' + color + ';">' +
                            res.message + '</span>');
            ...
            if (!validateLoginForm(datas)) {
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#loginErrors').html('');
                        if (res.status == 200) {
                            $('#loginErrors').append('<br><span style="color:green;">' + res
                                .message + '</span>');
                            $.magnificPopup.close();
                            $("#userId").val(res.userId);
                            ...
                            $('#loginErrors').append('<br><span style="color:red;">' + res
                                .message + '</span>');
                        }
                        // }, 5000);
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#docErrorMessages").html(
                        '<span style="color:green;">Documents uploaded successfully.<span>');
                    setTimeout(function() {
                        $("#docErrorMessages").html('');
                        $.magnificPopup.close();
                        $('#uploadDocs')[0].reset();
                ...
                error: function(xhr) {
                    if (xhr.status === 422) {
                        ...
                        Object.keys(errors).forEach(function(key) {
                            $("." + key + "").html('<span style="color:red;">' + errors[key]
                                [0] + '<span>');
                            setTimeout(function() {
                                $("." + key + "").html('');
                            }, 5000);
                        ...
                        $("#docErrorMessages").html(
                            '<span style="color:red;">An error occurred during the upload.<span>'
                            );
                        setTimeout(function() {
                            $("#docErrorMessages").html('');
                        }, 5000);
            ...
            success: function(res) {
                if (res.cnt == 0) {
                    if (!validateBookingForm()) {
                        if (res.data.eidf_flag == 0 && res.data.eidb_flag == 0 && res.data.dlf_flag == 0 &&
                            res.data.dlb_flag == 0 && res.data.passf_flag == 0 && res.data.passb_flag ==
                            0 && res.data.cdlf_flag == 0 && res.data.cdlb_flag == 0) {
                            ...
                            if ((res.data.cdlf_flag == 0 || res.data.cdlb_flag == 0) && res.data
                                .user_type == 'T') {
                                $("#country-dl-section").show();
                            }
                    ...
                    if (!validateBookingForm()) {
                        if ($('#pickupdate').length) {
                            ...
                            $("#docErrorMessages").html(
                                '<span style="color:red;">Please fill up the booking details.<span>');
                            setTimeout(function() {
                                $("#docErrorMessages").html('');
                            }, 5000);
                        }
